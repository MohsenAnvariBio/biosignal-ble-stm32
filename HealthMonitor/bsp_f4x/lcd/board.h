...
#define SPI						SPI2
#define LCD_SCL_PIN				MCU_GPIO_PIN_13  //SCK
#define LCD_SCL_PORT			GPIOB
#define LCD_SDI_PIN				MCU_GPIO_PIN_15  //MOSI
#define LCD_SDI_PORT			GPIOB
#define LCD_SDO_PIN				MCU_GPIO_PIN_2  //MISO
#define LCD_SDO_PORT			GPIOC

#define LCD_RESX_PIN			MCU_GPIO_PIN_4
#define LCD_RESX_PORT			GPIOB
#define LCD_DCX_PIN				MCU_GPIO_PIN_5
#define LCD_DCX_PORT			GPIOB
#define LCD_CSX_PIN				MCU_GPIO_PIN_6
#define LCD_CSX_PORT			GPIOB
